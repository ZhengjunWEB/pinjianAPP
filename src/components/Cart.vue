<template>
    <div class="wrpper-cart">
        ...
        <div class="wrpper-cart-mian">
          <div class="wrpper-cart-pd" v-if="cartList.length == ''">
              <div class="wrpper-cart-pd_error">
                  <dd><img src="../assets/images/cart/cart_error.png" alt=""></dd>
            ...
            <div class="wrpper-cart-list">
                ...
                <div class="wrpper-cart-list-item clearfix" v-for="(v,k) in cartList" :key="k">
                    ...
                    <div class="wrpper-cart-list-item-r pull-right p-relative">
                        ...
                        <div class="name">戴尔其</div>
                        <div class="kuans">款式</div>
        ...
        <div class="footer">
           ...
           <div class="con" v-if="isHide">
              ...
              <div class="pircses">免运费</div>
           </div>
            <div class="btn" @click="jiesuan()" v-if="isHide">立即结算</div>
            <div class="btn_yr" v-if="isHide_to">移入收藏夹</div>
...
export default {
  ...
  methods: {
    ...
    qiehuan(val){
      ...
      if(val == 1){
        _this.ifCarIMg_true = require('../assets/images/cart/flase_s.png');
        _this.isHide = false;
        _this.isHide_to = true;
        // _this.Cart_con();
      }else{
        _this.ifCarIMg_true = require('../assets/images/cart/flase_a.png');
        _this.isHide = true;
...
.wrpper-cart{
  ...
  .wrpper-cart-pd_error{
    ...
    dd{
      ...
      border:rem(5px) solid rgba(0,0,0,1);
      border-radius:50%;
      position: relative;
      img{
        display:block;
  ...
  .footer{
    ...
    .btn_yr{
      ...
      border:1px solid rgba(255,200,90,1);
    ...
    .btn_sc{
      ...
      height:rem(60px);
      line-height:rem(60px);
      border:1px solid rgba(203,72,72,1);
      border-radius:rem(54px);
      text-align: center;
      font-family:font_pc;
      font-weight:400;
