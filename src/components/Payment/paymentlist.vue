<template>
  <div class="payment">
            ...
            <div class="payment_main-t" v-if="dizhiL != null">
                <div class="payment_main-t-lits">
                    ...
                    <div class="item-con" @click="link_asses()">
                         <p class="item-con-t">
                            <strong>{{receive_name}}</strong>
                            <span>{{receive_tel}}</span>
                        </p> 
                        <p class="item-con-b">{{area_info}}</p>
                        <img class="v" src="../../assets/images/Index_Img/btn_left.png" alt="">
                    </div>
                </div>
            </div>
            <div class="payment_main-a" v-else @click="link_assess()">
                <div class="s">添加收货地址<img class="v" src="../../assets/images/Index_Img/btn_left.png" alt=""></div>
            </div>
            <div class="payment_main-b">
                <div class="dds">
                    <div class="payment_main-t-list">
                        <div class="payment_main-t-item" v-for="(v,k) in qianbao" :key="k">
                            <div class="wrpper-cart-list-item-l"><img :src="v.image" alt=""></div>
                    ...
                    <div class="payment_main-t-bot">
                        <div class='payment_main-t-botitem'>
                            ...
                            <div class="sp_two">快递 免费<img src="../../assets/images/Index_Img/btn_left.png" alt="" style="visibility:hidden;"></div>
                        </div>
                        ...
                        <div class="payment_main-t-bot_list" v-if="is_show">
                            <div class="payment_main-t-bots" @click="xiugai(1)">
                                <img class="icon wx" src="../../assets/images/Index_Img/wx.png" alt="">
                                <b>微信支付</b>
                                <p :class="istrue1?'active':''"><img src="../../assets/images/Index_Img/gou.png" alt=""></p>
                            </div>
                            <div class="payment_main-t-bots" @click="xiugai(2)">
                                <img class="icon zfb" src="../../assets/images/Index_Img/zfb.png" alt="">
                                <b>支付宝支付</b>
                                <p :class="istrue2?'active':''"><img src="../../assets/images/Index_Img/gou.png" alt=""></p>
                            </div>
                            <div class="payment_main-t-bots" @click="xiugai(3)">
                                <img class="icon qb" src="../../assets/images/Index_Img/zf.png" alt="">
                                <b>钱包支付</b>
                                <p :class="istrue3?'active':''"><img src="../../assets/images/Index_Img/gou.png" alt=""></p>
                            </div>
                        </div>
                        <div class='payment_main-t-botitem'>
                            <div class="sp_one">订单备注</div>
                            <div class="sp_two s"><input type="text" v-model="text_mesg" placeholder="针对此订单的描述和要求做补充"></div>
                        </div>
        ...
        <div class="payment_main-f">
            <div class="pirce"><span>商品金额：￥{{Num_pirce}}</span><span class="s">({{Num_len}}件)</span><span class="q">优惠卷：-￥0</span></div>
            <div class="pirce_con"><span>运费：￥0</span><span class='s'>合计：￥{{Num_pirce}}</span></div>   
  ...
  name: 'loading',
    ...
    methods: {
        ...
        link_asses(){
            ...
            localStorage.setItem('get_Android_rouit_id',JSON.stringify(this.userindo));
        ...
        submit(){
            ...
            if(this.money_pay == 1){
                    $this.$post($this.$api.create_order, {
    ...
    mounted() {
        ...
        $this.userinfo = $this.userindo.id + '|' + $this.userindo.bid + '|' + $this.userindo.pid;
        // $this.dizhiL = store.state.user_dizhi;
        // console.log($this.dizhiL);
        // console.log($this.dizhiL);

        $this.$post($this.$api.get_befor_order, {
            token:localStorage.getItem('token'),
            type:0,
            info: $this.userinfo
        }).then(data => {
            ...
            for(var i = 0; i < $this.qianbao.length;i++){
                $this.Num_pirce += $this.qianbao[i].goods_price * $this.qianbao[i].goods_num;
        ...
        if(paymentlist == null){
            ...
            $this.dizhiL = JSON.parse(localStorage.getItem('paymentlist'));
